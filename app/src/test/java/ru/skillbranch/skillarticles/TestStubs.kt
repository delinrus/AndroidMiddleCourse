...
after simple text
""".trimIndent()
val expectedImages: Map<String, List<String?>> = mapOf(
    "titles" to listOf(
    ...
    "links" to listOf(
        ...
        "/assets/images/canada-magic-land.jpg",
...
""".trimIndent()
val expectedMultilineCode: List<String> = listOf(
    "code block.code block.code block",
    "multiline code block\nmultiline code block\nmultiline code block\nmultiline code block"
)
